...
# stay >= 27.9 apart under protan/deutan/tritan simulation, and each compartment keeps
# a fixed dodge order within every row as a colour-independent cue; shape stays reserved
# for supplement detection. (Per-compartment CI linetypes were tried 2026-09-23 and
# dropped 2026-09-25 at Andrew's request -- not needed at dE >= 27.9.)
