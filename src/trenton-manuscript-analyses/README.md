...
| `Compartment Tracking.Rmd` | Cross-compartment transfer (Fig S7 / Fig 6D) | 87 plotting calls — his original cross-compartment figure code; our `fig6D-crosscompartment.R` was built from his DATA and should be reconciled against this |
