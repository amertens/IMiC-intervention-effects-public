...
saveRDS(res_primary, file=paste0(here::here(),"/results/adjusted_combined_arms_HMtraj_primary_intervention_effects_results.RDS"))
...
saveRDS(res_tertiary, file=paste0(here::here(),"/results/adjusted_combined_arms_HMtraj_tertiary_intervention_effects_results.RDS"))
