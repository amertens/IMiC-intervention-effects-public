...
#analyze HMO concentrations, not percents
HMO_vars = all_milk_components$hmo[!(grepl("_pct",all_milk_components$hmo))]
...
#Glmnet fails in vital study for some outcomes, so run separately with it excluded from library
